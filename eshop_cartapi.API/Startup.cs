...
using eshop_cartapi.Business.ViewModels.Account;
...
namespace eshop_cartapi.API
{
    public class Startup
    {
        ...
        {
            services.AddMvc();
            services.AddDbContext<eshop_cartapiContext>(options => options.UseLazyLoadingProxies(false).UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            services.AddIdentity<ApplicationUser, IdentityRole>().AddEntityFrameworkStores<eshop_cartapiContext>().AddDefaultTokenProviders();
